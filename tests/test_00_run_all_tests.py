...
if __name__ == '__main__':
    ...
    test_modules = [
        ...
        'tests.test_02_0_capec_to_cwe',
        'tests.test_02_1_capec_to_cwe',
        'tests.test_03_0_cwe_to_capec',
        'tests.test_03_1_cwe_to_capec',
        'tests.test_04_0_attack_to_capec',
        'tests.test_05_0_cve_to_cwe',
        'tests.test_05_1_cve_to_cwe',
        'tests.test_05_2_cve_to_cwe',
        'tests.test_06_0_cve_to_cpe',
#        'tests.test_06_1_cve_to_cpe',
#        'tests.test_06_2_cve_to_cpe',
        'tests.test_07_0_sigma_to_attack',
        'tests.test_07_1_sigma_to_attack',
        'tests.test_07_2_sigma_to_attack',
        'tests.test_08_0_sigma_to_cve',
        'tests.test_08_1_sigma_to_cve',
        'tests.test_08_2_sigma_to_cve',
